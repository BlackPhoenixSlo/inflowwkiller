...
## Prefill = PRODUCTION (reference accounts: **NovaFree + Ava**, read live 2026-07-22 post-recovery)
| Thing | Prefill |
|---|---|
...
| AI seller preset | **"Aggressive Seller"**: always-on, proactive (NO intent gate on Nova/Ava) · qualification gate ON · smart pricing ON · rhythm ON (no-sleep) · post-buy rung + gift ON · engage old fans ON · force-ask after 9 fan msgs |
...
| Auto Posts | every **3–7 h** (Nova 7h) · Auto Stories every **4–7 h**, 2/run, live ~14 h |
