      ...
      >
        ...
        <div className="px-4 py-2 border-b border-border flex flex-wrap gap-4 text-[11px] text-fg-dim">
          ...
          <button
            ...
            title="Measured on NovaFree: the badges flag 40 items to catch 11 of the 24 actually wrong — 28% precision, 46% recall. Good enough to sort by, NOT good enough to hide behind, which is why the full list is the default."
          >
            {onlyIffy
