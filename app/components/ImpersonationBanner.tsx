...
export function ImpersonationBanner() {
  ...
  return (
    <div className="sticky top-0 z-40 bg-amber-500 text-black text-sm">
      <div className="max-w-7xl mx-auto px-3 lg:px-6 py-2 flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          onClick={() => void onExit()}
          disabled={busy}
          className="ml-auto px-2.5 py-1 rounded bg-black/15 hover:bg-black/25 font-medium disabled:opacity-50"
        >
