...
function ruleToForm(rule: AutomationRule | null): Form {
  ...
  return {
    ...
    everyMinutes: every,
    excludeRepliedHours: typeof p.exclude_replied_hours === "number" ? p.exclude_replied_hours : "",
    ...
    <div className="space-y-5 max-w-2xl">
      ...
      <Card className="p-4 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <NumField label="Exclude DMed within (hrs)" value={form.excludeRepliedHours === "" ? 0 : form.excludeRepliedHours}
        ...
        <Hint>
          <b>Send every</b>: how often to broadcast. <b>Exclude DMed within</b>: skip fans you’ve messaged
          in the last N hours so you don’t blast active threads (0 = off). <b>Auto-unsend</b>: remove the
          broadcast after N hours (0 = keep).
        </Hint>
