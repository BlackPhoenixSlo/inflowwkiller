...
`GET /notifications`. Confirmed live 2026-09-02 on a real $3 sale:
    ...
    {"id": "900442430324908036",          # stable -> our idempotency key
     "type": 2007,                        # media purchase
     "correlationId": "900440044332167168",     # the accountMedia grant bought
     "correlationGroupId": "900404711209099264", # the BUYER
