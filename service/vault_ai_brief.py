...
#   * `breasts_covered` came back `false` on 94 of 103 NovaFree items,
...
def fold_vis(states: list[str]) -> str:
    ...
    conflation is why 20 of 21 NovaFree clips folded to "uncovered".
    """
...
# contradictions on 103 NovaFree items (13.6%); anything that replaces them has
# to beat that.
