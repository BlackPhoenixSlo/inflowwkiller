...
class Slot:
    ...
    def __init__(self, key: str, name: str, source: str, pool: str,
        ...
        # Observed on NovaFree — the `mass` lane is suggestive-only, but a
        ...
        # deep lane (NovaFree's `mass` holds 53) yields several genuinely
...
async def propose_week(account_id: str, *, min_set: int = MIN_SET
    ...
    # leftovers slot down to 3 media on NovaFree. Every slot type earns a bundle
